...
//import com.tingsic.databinding.ActivityCameraBinding;
//import com.tingsic.viewmodel.CameraViewModel;
//import com.tingsic.viewmodelfactory.ViewModelFactory;
//
//import java.io.File;
...
//        mBuilder.setCancelable(false);
//        mBuilder.setCanceledOnTouchOutside(false);
//        progressBinding = DataBindingUtil.inflate(LayoutInflater.from(this), R.layout.dialog_progress, null, false);
//        progressBinding.progress_bar.setShader(new int[]{ContextCompat.getColor(this, R.color.colorTheme2), ContextCompat.getColor(this, R.color.colorTheme1), ContextCompat.getColor(this, R.color.colorTheme)});
//
